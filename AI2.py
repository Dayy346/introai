...
# Generate and visualize 50 grid worlds
for i in range(50):
    ...
    # Visualize and save the grid world
    grid_np = np.array(grid_world)  # Convert to NumPy array for visualization
    visualize_grid(grid_np == '0', f'grid_world_visual_{i}.png')  # Visualize '0' cells only
